...
# 回答錯誤2頁面
class Ui_Error2(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super().__init__(parent)  # 將父物件傳入

    def setupUi(self):
        self.setObjectName("Error2Window")
        ...
        # 設定背景圖片
        self.background_path = os.path.abspath('./Screen/img/fail1.png')
    ...
    def retranslateUi(self):
        ...
        self.label_4.setText(_translate("ErrorWindow", "請再接再厲！"))
        self.label_5.setText(_translate("ErrorWindow", "剩餘答錯機會:1次！"))
